...
ALLOWED_EFFECTS: dict[AssemblingMachine, set[str]] = {
    AssemblingMachine.StoneFurnace: {"speed", "consumption", "pollution"},
    AssemblingMachine.OffshorePump: set(),
    AssemblingMachine.AssemblingMachine1: {"speed", "consumption", "pollution"},
    AssemblingMachine.AssemblingMachine2: {
        "speed",
        "productivity",
        "quality",
    ...
    AssemblingMachine.SteelFurnace: {"speed", "consumption", "pollution"},
    AssemblingMachine.AssemblingMachine3: {
        "speed",
        "productivity",
        "quality",
    ...
    AssemblingMachine.RocketSilo: {"speed", "productivity", "consumption", "pollution"},
    ...
    AssemblingMachine.Pumpjack: {"speed", "productivity", "consumption", "pollution"},
}
