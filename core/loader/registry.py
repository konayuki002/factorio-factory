...
# JSON -> Python submodel用 allowed Enumメンバsets 定義変換パッケージのディレクトリを動的に読み取る
allowed_converters_module_name = "core.loader.converters.model.allowed"
dynamic_import_one_by_one(allowed_converters_module_name)
